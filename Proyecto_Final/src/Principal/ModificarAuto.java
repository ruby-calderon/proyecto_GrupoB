...
public class ModificarAuto extends JDialog implements ActionListener {
	...
	public ModificarAuto() {
		...
		txtTorque.setBackground(SystemColor.textHighlightText);
		...
		txtStock.setBackground(SystemColor.textHighlightText);
		...
		txtGarantia.setBackground(SystemColor.textHighlightText);
		txtGarantia.setBounds(66, 150, 89, 20);
		contentPanel.add(txtGarantia);
		
		btnGuardar = new JButton("Guardar");
		btnGuardar.setBounds(345, 56, 89, 23);
